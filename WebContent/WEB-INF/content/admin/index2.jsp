     ...
     <!-- Navigation -->
		       ...
		       <div class="activity_box">
		        <div class="scrollbar" id="style-2">
                   <div class="activity-row">
	                 ...
	                 <div class="col-xs-3 activity-img"><img src='${root }/static-resources/admin/images/5.png' class="img-responsive" alt=""/></div>
	                 ...
	                 <div class="col-xs-3 activity-img"><img src='${root }/static-resources/admin/images/3.png' class="img-responsive" alt=""/></div>
	                 <div class="col-xs-8 activity-desc">
                    ...
                    <div class="activity-row">
	                 ...
	                 <div class="col-xs-3 activity-img"><img src='${root }/static-resources/admin/images/1.png' class="img-responsive" alt=""/></div>
	                 <div class="col-xs-8 activity-desc">
                    ...
                    <div class="activity-row1">
	                 ...
	                 <div class="col-xs-3 activity-img"><img src='${root }/static-resources/admin/images/4.png' class="img-responsive" alt=""/></div>
	                 <div class="col-xs-8 activity-desc">
	  ...
	  <div class="span_11">
		<div class="col-md-6 col_4">
		  ...
		  <!----Calender -------->
			<link rel="stylesheet" href="${root }/static-resources/admin/css/clndr.css" type="text/css" />
			<script src="${root }/static-resources/admin/js/underscore-min.js" type="text/javascript"></script>
			<script src= "${root }/static-resources/admin/js/moment-2.2.1.js" type="text/javascript"></script>
			<script src="${root }/static-resources/admin/js/clndr.js" type="text/javascript"></script>
			<script src="${root }/static-resources/admin/js/site.js" type="text/javascript"></script>
			<!----End Calender -------->
		</div>
...
var detail = new Rickshaw.Graph.HoverDetail({
	graph: graph
	      ...
	      <!-- map -->
<link href="${root }/static-resources/admin/css/jqvmap.css" rel='stylesheet' type='text/css'/>
<script src="${root }/static-resources/admin/js/jquery.vmap.js"></script>
<script src="${root }/static-resources/admin/js/jquery.vmap.sampledata.js" type="text/javascript"></script>
<script src="${root }/static-resources/admin/js/jquery.vmap.world.js" type="text/javascript"></script>
